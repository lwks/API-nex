...
class DynamoCompaniesRepository:
    """Repository implementation backed by DynamoDB for Company entities."""
    ...
    def _build_key(self, identifier: str) -> Dict[str, Any]:
        if not identifier:
            raise InvalidIdentifierError("Company identifier cannot be empty.")
    ...
    async def create(self, data: Dict[str, Any]) -> str:
        ...
        if not company_id:
            raise InvalidIdentifierError("Company identifier is required.")
