...
class DynamoUsersRepository:
    """Repository implementation backed by DynamoDB for User records."""
    ...
    def _build_key(self, identifier: str) -> Dict[str, Any]:
        if not identifier:
            raise InvalidIdentifierError("User identifier cannot be empty.")
    ...
    async def create(self, data: Dict[str, Any]) -> str:
        ...
        payload = {self._partition_key: user_id, **data}
